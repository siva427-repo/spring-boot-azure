package com.keeplearning.springbootcrudazure.controller;
...
import com.keeplearning.springbootcrudazure.Employee;

@EnableWebMvc
@RestController
@RequestMapping("/employee")
@CrossOrigin(origins = "https://angular-client-app.azurewebsites.net")
